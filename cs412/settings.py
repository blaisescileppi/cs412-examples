...
SECRET_KEY = 'django-insecure-l+*k$%-c!ua1$q@*3207*w4ybxh(a+x=7hg1c94kqq%53yxc81'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*', "127.0.0.1", "webapps.bu.edu"]
...
INSTALLED_APPS = [
    ...
    'hw', # NEW
    'quotes', # assignment 1
    'formdata', # assignment 2 practice
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'project.context_processors.user_profiles',
            ],
        },
    },
]
